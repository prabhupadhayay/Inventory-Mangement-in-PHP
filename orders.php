		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <!-- <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="orderDate" name="orderDate" disabled="true" autocomplete="off" />
			    </div>
			  </div> /form-group -->
			  <div class="form-group">
			    <label for="clientName" class="col-sm-2 control-label">Client Name</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control typeahead" id="clientName" name="clientName" placeholder=" search for Customer Name" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->
			  		...
			  		for($x = 1; $x < 4; $x++) { ?>
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
			  				<td style="margin-left:20px;">
			  					...
			  					<input type="text" class="form-control test" name="productName[]" id="productName<?php echo $x; ?>" onchange="getProductData(<?php echo $x; ?>)" >
			  					<input type="hidden" name="selectproductName" id="selectproductName<?php echo $x; ?>)">	
			  					</div>
			  				</td>
			  ...
			  <div class="col-md-6">
			  	<div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <input type="number"   class="form-control" id="subTotal" name="subTotal" disabled="true" min="0" />
				      <input type="hidden" class="form-control" id="subTotalValue" name="subTotalValue" />
				    </div>
				  </div> <!--/form-group-->			  
				  <div class="form-group">
				    <label for="vat" class="col-sm-3 control-label">VAT 1%</label>
				    <div class="col-sm-9">
				      <input type="number" class="form-control" id="vat" name="vat" disabled="true" />
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <input type="number" class="form-control" id="totalAmount" name="totalAmount" disabled="true"/>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <input type="number" class="form-control" id="discount"onkeypress="return event.charCode >= 48" min="1" name="discount" onkeyup="discountFunc()" autocomplete="off" min="0" required />
				    </div>
				  </div> <!--/form-group-->	
				  <div class="form-group">
				    <label for="grandTotal" class="col-sm-3 control-label">Grand Total</label>
				    <div class="col-sm-9">
				      <input type="number" class="form-control" id="grandTotal" name="grandTotal" disabled="true" min=0 oninput="validity.valid||(value='');"/>
				      <input type="hidden" class="form-control" id="grandTotalValue" name="grandTotalValue" min=0 oninput="validity.valid||(value='');" />
				    </div>
				  </div> <!--/form-group-->			  		  
			  </div> <!--/col-md-6-->
			  ...
			  <div class="col-md-6">
			  	<div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <input type="number"  min ="0" class="form-control" onkeypress="return event.charCode >= 48" min="1"id="paid" name="paid" autocomplete="off" onkeyup="paidAmount()" />
				    </div>
				  </div> <!--/form-group-->			  
				  <div class="form-group">
				    <label for="due" class="col-sm-3 control-label">Due Amount</label>
				    <div class="col-sm-9">
				      <input type="number" class="form-control" id="due" oninput="validity.valid||(value=''); min="0" name="due" disabled="true" />
				      <input type="hidden" class="form-control" id="dueValue" min="0" name="dueValue" />
				    </div>
				  </div> <!--/form-group-->		
				  <div class="form-group">
			  		...
			  		while($orderItemData = $orderItemResult->fetch_array()) { 
			  			...
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
			  				<td style="margin-left:20px;">
			  					...
			  					<input type="text" class="form-control" name="productName[]" id="productName<?php echo $x; ?>" onchange="getProductData(<?php echo $x; ?>)" >
